...
Ext.define('reservas_puce.view.wndNuevoUsuarioViewController3', {
    ...
    onBtnHorarioGuardarClick: function(button, e, eOpts) {
        if(Ext.getCmp('txtNuevoHorarioHoraInicio').getValue() >= Ext.getCmp('txtNuevoHorarioHoraFin').getValue()){
            Ext.Msg.alert('Alerta','La hora fin debe ser mayor a la de inicio.');
        }
        else{
